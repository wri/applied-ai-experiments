...
This experiment attempts to generate a natural language AI summary of
deforestation alerts data for a target user of Places To Watch. 
...
For motivation and details, see [brief.md](./brief.md), and 
