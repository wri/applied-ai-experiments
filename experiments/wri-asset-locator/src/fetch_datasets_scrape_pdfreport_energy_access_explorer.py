...
def _(Path, pd, re):
    ...
    def add_row(name, category, group, unit=None, eap=True, demand=None, supply=None, need=None, tags=None, description=None):
        row = {
    ...
    add_row(
        ...
        group="Demand",
        unit="People/km²",
        eap=True, demand=True, supply=None, need=None,
    ...
    add_row(
        ...
        eap=True, demand=True, supply=None, need=True,  # Need for Assistance uses higher when far/poor per Table 1
    ...
    add_row(
        ...
        eap=True, demand=True, supply=None, need=True,
    ...
    add_row(
        ...
        eap=True, demand=None, supply=True, need=None,
        tags=["solar", "GHI"],
    ...
    add_row(
        ...
        eap=True, demand=None, supply=True, need=True,
    ...
    cols = [
        "id","name","category","group","unit",
        "usedIn_EAP","usedIn_Demand","usedIn_Supply","usedIn_NeedAssist",
        "provider","tags","layerCount","layerNames",
        "createdAt","dataLastUpdated","updatedAt",
        "description"
    ]
    df = df[cols]

    # Save to CSV
    out_path = Path("eae_datasets_pdf-extract.csv")
